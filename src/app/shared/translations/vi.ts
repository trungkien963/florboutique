...
export const VI: Translations = {
  ...
  storyFounder1Role: 'Anh Chàng IT',
  storyFounder1Desc: 'Lo liệu từ website đến phần mềm đặt hàng, để bạn chọn hoa dễ dàng chỉ với vài cú click chuột.',
  storyFounder2Role: 'Cô Nàng Marketing',
  storyFounder2Desc: 'Người gói gém câu chuyện của những bông hoa qua từng bức ảnh và dòng chữ để gửi đến bạn.',
  storyFounder3Role: 'Người Bạn Finance',
  storyFounder3Desc: 'Quản lý thu chi cẩn thận để Flơr luôn có được những bông hoa tươi nhất với giá cả hợp lý nhất.',
};
